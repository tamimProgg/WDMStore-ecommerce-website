        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <ul className="space-y-3 text-gray-300 p-4 bg-gray-800 rounded-xl border border-gray-700">
              ...
              <li className="flex items-center space-x-3 text-lg">
                <Zap className="w-5 h-5 text-orange-500" />
                <span>Immidiate Shipping for In-Stock Items</span>
              </li>
            </ul>

        <div className="mt-5 space-y-5 flex flex-col justify-center items-center">
          <button className="w-full py-3 bg-orange-600 text-white font-bold rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-3 hover:ring-orange-600 uppercase tracking-wider">
            <ShoppingCart className="w-5 h-5" />
            <span>Add to Cart</span>
          </button>

          <Link to={'/'} className="w-full py-3 border-2 border-orange-600 text-orange-400 font-bold rounded-full cursor-pointer hover:bg-orange-900/50 hover:text-white transition duration-300 text-center transform  uppercase tracking-wider">
            Keep Shopping
          </Link>
        </div>
        </div>
